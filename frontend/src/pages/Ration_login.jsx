...
import { ArrowLeft, RefreshCw, Eye, EyeOff } from 'lucide-react'; // Import Eye and EyeOff icons
import Header from '../components/Header';

export default function Ration_login() {
  const [username, setUsername] = useState(''); // Changed from aadharId to username
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:5000/login', {
        ...
        body: JSON.stringify({
          center_id: id, // Use the id state value
          username: username, // Use the username state value
      ...
      // Store the center_id and role in localStorage
